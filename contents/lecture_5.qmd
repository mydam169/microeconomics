...
def eqline(q):
    return q
plt.plot(q, BR1(q), label='$BR_1(q_2)$', color='k', lw=1.5)
plt.plot(q, BR2(q), label='$BR_2(q_1)$', color='C0', lw=1.5)
...
plt.scatter(qstar, qstar, color='r', s=50, label="Cournot NE")

# annotations
plt.vlines(x=qstar, ymin=0, ymax=qstar, linestyle='--', lw=.5, color='k')
plt.hlines(y=qstar, xmin=0, xmax=qstar, linestyle='--', lw=.5, color='k')
plt.text(qstar*0.85, -.5, "$\\frac{a-c}{3b}$")
plt.text(qmid*0.95, -.5, "$\\frac{a-c}{2b}$")
plt.text(qmax*0.95, -.5, "$\\frac{a-c}{b}$")
plt.text(-0.75, qstar*0.9, "$\\frac{a-c}{3b}$")
plt.text(-0.75, qmid*0.95, "$\\frac{a-c}{2b}$")
plt.text(-0.75, qmax, "$\\frac{a-c}{b}$")
...
* Profits:
    ...
    Hence the leader earns a higher profits than in the Cournot case thanks to the first mover advantage, but the follower earns lower profits.
