...
Note that $x$ can be different from $e$ with trade. An allocation is __feasible__ if $x \geq e$. In particular, this requires:
$$ 
\begin{aligned}
x_1^A + x_1^B &\leq e_1^A + e_1^B, \\
x_2^A + x_2^B &\leq e_2^A + e_2^B. 
\end{aligned}
$$
    
* Any point _within_ the Edgeworth box is feasible
